...
function App() {
  ...
  <ScrollArea className="h-screen w-full">
        <div className="pb-64">
          ...
          {/* 説明文とアンケートボタン */}
          <div className="px-4 pt-6 pb-4 space-y-4" style={{ maxWidth: '55%', display: 'center'}}>
          ...
          <div className="px-4 pt-6 space-y-4 mb-6">
            <div style={{ maxWidth: '55%', display: 'center'}}>
              <FinanceScore 
          ...
          {/* 中部セクション: 未来シミュレーション */}
          <div className="px-4 space-y-4 mb-6" style={{ maxWidth: '55%' }}>
            <div className="flex items-center gap-2 mb-2">
              <div className="w-1 h-6 bg-purple-500 rounded-full" />
              <span className="text-gray-700" style={{ maxWidth: '55%' }}>未来予測</span>
            </div>
          ...
          {/* カテゴリー別支出ハイライト */}
          <div className="px-4 space-y-4" style={{ marginBottom: '250px', maxWidth: '55%' }}>
            <div className="flex items-center gap-2 mb-2">
